...
public class BagOfWordsDataProvider implements ArgumentsProvider {
    ...
    public Stream<? extends Arguments> provideArguments(ExtensionContext context) throws Exception {
        ...
        list1.add(new BagOfWords.WordFrequency(1, 1L));
        list1.add(new BagOfWords.WordFrequency(2, 1L));
        list1.add(new BagOfWords.WordFrequency(3, 0L));
        wordFrequency.put("word1", list1);

        List<BagOfWords.WordFrequency> list2 = new ArrayList<>();
        list2.add(new BagOfWords.WordFrequency(1, 2L));
        list2.add(new BagOfWords.WordFrequency(2, 0L));
        list2.add(new BagOfWords.WordFrequency(3, 1L));
        wordFrequency.put("word2", list2);

        List<BagOfWords.WordFrequency> list3 = new ArrayList<>();
        list3.add(new BagOfWords.WordFrequency(1, 1L));
        list3.add(new BagOfWords.WordFrequency(2, 1L));
        list3.add(new BagOfWords.WordFrequency(3, 0L));
        wordFrequency.put("word3", list3);

        List<BagOfWords.WordFrequency> list4 = new ArrayList<>();
        list4.add(new BagOfWords.WordFrequency(1, 0L));
        list4.add(new BagOfWords.WordFrequency(2, 1L));
        list4.add(new BagOfWords.WordFrequency(3, 0L));
        wordFrequency.put("word4", list4);

        List<BagOfWords.WordFrequency> list5 = new ArrayList<>();
        list5.add(new BagOfWords.WordFrequency(1, 0L));
        list5.add(new BagOfWords.WordFrequency(2, 1L));
        list5.add(new BagOfWords.WordFrequency(3, 0L));
