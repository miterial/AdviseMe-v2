...
public class RecommendedUserMovieDtoOut extends UserMovieDtoOut {
    ...
    public RecommendedUserMovieDtoOut(String movie_id, String movie_title, String movie_overview, Double user_rating, Double avg_rating, LocalDate user_rating_date, Integer like_probability) {
